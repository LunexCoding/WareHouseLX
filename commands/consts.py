...
class Commands:
    ...
    COMMAND_ADD_WORKSHOPS = COMMAND(17, Constants.COMMAND_ADD, dict(table=DatabaseTables.WORKSHOPS))
    ...
    COMMAND_DELETE_WORKSHOPS = COMMAND(24, Constants.COMMAND_DELETE, dict(table=DatabaseTables.USERS))
    COMMAND_DELETE_CLIENT = COMMAND(25, Constants.COMMAND_DELETE, dict(table=DatabaseTables.CLIENTS))
    ...
    COMMAND_UPDATE_WORKSHOPS = COMMAND(31, Constants.COMMAND_UPDATE, dict(table=DatabaseTables.USERS))
    COMMAND_UPDATE_CLIENT = COMMAND(32, Constants.COMMAND_UPDATE, dict(table=DatabaseTables.CLIENTS))
